...
(function () {
  ...
  var PHOTOS = [
    ...
    { id: "sali-02", cat: "sali", caption: "Sali ja näyttämö" },
    { id: "sali-03", cat: "sali", caption: "Näyttämön verhot" },
    { id: "sali-04", cat: "sali", caption: "Pitkät pöydät" },
    { id: "sali-05", cat: "sali", caption: "Lava ja samettiesirippu" },
    { id: "sali-06", cat: "sali", caption: "Sali arkiasussaan" },
    { id: "sali-07", cat: "sali", caption: "Valmiina vieraille" },
    { id: "sali-08", cat: "sali", caption: "Salin kattaus" },
    { id: "kahvila-01", cat: "kahvila", caption: "Kahvilan ikkunapöydät" },
    { id: "kahvila-02", cat: "kahvila", caption: "Kahvilan tunnelmaa" },
    { id: "kahvila-03", cat: "kahvila", caption: "Pitkä pöytä seurueelle" },
    { id: "kahvila-04", cat: "kahvila", caption: "Vanha seinäkello" },
    { id: "kahvila-05", cat: "kahvila", caption: "Saksofoni seinällä" },
    { id: "kahvila-06", cat: "kahvila", caption: "Vanha piano" },
    { id: "kahvila-07", cat: "kahvila", caption: "Moulin Rouge -nurkkaus" },
    { id: "kahvila-08", cat: "kahvila", caption: "Piano ja kaakeliuuni" },
    { id: "kahvila-09", cat: "kahvila", caption: "Antiikkisenkki" },
    { id: "kahvila-10", cat: "kahvila", caption: "Kahvilan kattauspöytä" },
